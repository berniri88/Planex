        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center pointer-events-none z-[101] p-4">
            <motion.div
              ...
              className="bg-popover rounded-[2.5rem] shadow-2xl w-full max-w-lg p-10 relative flex flex-col pointer-events-auto max-h-[90vh] overflow-y-auto no-scrollbar border border-border"
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="space-y-4">
                   <div className="flex gap-2 p-1 bg-secondary border border-border rounded-2xl">
                      {currencies.map(c => (
                        <button
                          key={c.code}
                          type="button"
                          ...
                          className={cn(
                            "flex-1 py-3 px-3 rounded-xl transition-all font-black text-xs uppercase tracking-widest",
                            currency === c.code 
                   ...
                   <div className="relative group">
                      ...
                      <input 
                         ...
                         type="number"
                         step="0.01"
                         className="w-full pl-12 pr-6 py-6 bg-secondary rounded-[2rem] border-2 border-border focus:border-primary/20 outline-none text-4xl font-black tracking-tighter placeholder:text-muted-foreground/10 h-24" 
                         placeholder="0.00" 
                         value={amount}
                   ...
                   <div className="relative group">
                      ...
                      <input 
                         required
                         className="w-full pl-16 pr-6 py-5 bg-secondary rounded-[2rem] border-2 border-border focus:border-primary/20 outline-none text-sm font-bold placeholder:text-muted-foreground/20" 
                ...
                <div className="flex items-center justify-between p-6 rounded-[2rem] bg-secondary border border-border transition-all">
                   <div className="flex items-center gap-4">
                      <div className={cn("w-12 h-12 rounded-[1.5rem] flex items-center justify-center transition-colors shadow-sm", isPrivate ? "bg-amber-500 text-white" : "bg-primary text-white")}>
                ...
                <Button type="submit" className="w-full h-16 text-xl font-black tracking-widest uppercase rounded-[2rem] shadow-xl shadow-primary/20">
                   Add to Ledger
                </Button>
              </form>
            </motion.div>
